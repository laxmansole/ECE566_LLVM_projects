...
{
       0,    79,    79,    90,   129,   136,   143,   144,   147,   154,
     158,   162,   166,   170,   174,   178,   184
};
#endif
...
{
  "$end", "error", "$undefined", "ASSIGN", "SEMI", "COMMA", "MINUS",
  "PLUS", "VARS", "MULTIPLY", "DIVIDE", "RAISE", "LESSTHAN", "TMP", "NUM",
  "ID", "$accept", "program", "decl", "varlist", "stmtlist", "stmt",
  "expr", YY_NULLPTR
};
#endif
...
{
      -5,     0,    18,     8,   -16,    -3,   -16,    19,     8,   -16,
     -16,     9,    -2,   -16,   -16,    -2,   -16,   -16,   -16,    10,
      -4,   -16,    -2,    -2,    -2,    -2,    -4,    -4,   -16,   -16
};
...
{
       0,     0,     0,     0,     5,     0,     1,     0,     2,     7,
       3,     0,     0,     6,     4,     0,    16,    14,    15,     0,
      11,     8,     0,     0,     0,     0,     9,    10,    12,    13
};
...
{
      20,    10,    11,     1,    15,    24,    25,    26,    27,    28,
      29,    16,    17,    18,    21,     4,    22,    23,     6,    24,
      25,     7,    12,    13,    14
};

static const yytype_uint8 yycheck[] =
{
      15,     4,     5,     8,     6,     9,    10,    22,    23,    24,
      25,    13,    14,    15,     4,    15,     6,     7,     0,     9,
      10,    13,     3,     8,    15
};
...
{
       0,     8,    17,    18,    15,    19,     0,    13,    20,    21,
       4,     5,     3,    21,    15,     6,    13,    14,    15,    22,
      22,     4,     6,     7,     9,    10,    22,    22,    22,    22
};
